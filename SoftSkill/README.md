...
## 38. 뽀모도로 기법
#### 생산성
몇 년간 몇 가지 생산성 기법을 시도해본 결과 뽀모도로 기법을 사용할 때 생산성이 가장 좋았다.
1980년대 후반 프란체스코 치릴로가 고안했으며 1990년대에 와서야 주목을 받기 시작했다. 
먼저 하루 동안 해야 할 일을 계획한다. 그 후 타이머를 25분으로 설정하고 첫번째 일을 시작한다.
작업은 한번에 한 개만 진행하고, 25분 동안 완전히 집중해서 일해야 한다.
25분이 끝나면 다시 타이머를 5분으로 설정하고 휴식을 취한다. 여기 까지가 1 뽀모도리다.
뽀모도리를 네 번 반복하고 나면 15분 동안 긴 휴식을 취한다.
이 기법의 진정한 힘은 작업 예측 및 측정 도구로 사용하는데 있다.
하루에 뽀모도리를 몇 번 실행했는지 기록하고 완료할 뽀모도리의 개수를 목표로 설정하면 스스로 하루에 얼마나 열심히 일하는지, 얼마나 많은 일을 처리할 수 있는지 정확히 측정할 수 있다.

#### 죄책감
열심히 일한 날이었다면 자신에게 뿌듯함을 느끼는 것이 정상이다.
내가 겪었떤 큰 문제 중 하나는 일을 더 해야 할 것만 같은 죄책감이었다. 
일을 많이 했을 때도 항상 느끼는 감정으로 절대로 쉬면 안 될 것 같았다.
종일 소처럼 일했는데도 목록에 있는 작업을 모두 완료하지 못하고, 어마어마한 노력을 기울였음에도 실패한 것 같다고 느끼다.
정말 중요한 것은 집중해서 완료한 작업의 양이다.
하루 동안 뽀모도리 몇개를 해내겠다는 목표를 세우고 이를 완수해냈다면 그날 할 수 있는 일은 모두 해낸 것으로 볼 수 있으며,
자신에게 뿌듯함이나 대견함을 느껴도 좋다. 이런 날에는 충분한 휴식을 취할 권리가 있다.

#### 뿌듯함 
이러한 깨들음 덕분에 내 업무의 질은 상당히 좋아졌으며 더 많은 일을 해내는 것은 물론 휴식 시간도 충분히 즐길 수 있게 되었다.
하루 동안 목표로 했떤 뽀모도리를 모두 완수하고 나면 남는 시간에는 무엇을 하든 상관없다.
오늘 하루는 열심히 일했다는 것을 스스로 알고 있기에 무엇을 해도 죄책감이 들지 않는다.
...
#### 힘든 일을 하는 방법
목표를 이룰 방법은 하나밖에 없 다. 자신의 모든 잠재력을 발휘할 수 있는 방법은 칼을 갈고, 이를 악물고, 일하러 가는 것이다.

## 48. 뭐라도 하는 게 아무것도 하지 않은 것보다 낫다
아무런 행동도 하지 않는 것은 주차된 차의 핸들을 돌리는 행위와 비슷하다. 주차된 차의 핸들을 돌려본 적이 있는가? 꽤 힘이 많이 들어간다. 핸들은 주행 중에 돌리는게 훨씬 쉽다.

## 58. 나는 33세에 은퇴했다
다양한 불로소득원을 마련해야 은퇴가 가능하다.
수익을 모두 투자해라. 최소한의 생활비만 남겨두고 투자하지 않으면, 저축한 돈으로는 50~60세가 되었을 때 노후자금으로 쓰다 얼마 후 다 사라질 것이다. 
부업할 기회를 잡아라. 자신을 마케팅을 잘하면 부업 기회도 늘어난다. 
저자는 부동산 담보 대출로 매년 집 한채 씩을 사서 임대 수익을 올렸다. 월 500만원씩 수입이 생긴 것이다. 
계약금 10%를 제외한 90% 레버리지를 이용한 것이다. 
